  ...
  <div className='bg-gray-800 relative w-full grow'>
    <div className='container flex mx-auto px-16 py-16 justify-between items-center'>
      <div id='projects' className='w-1/2'>
        ...
        <button className='rounded-xl border-white bg-gray-800 p-3 mr-2 mb-5 inline-block disabled'>Coming Soon</button>
        <span className="flex flex-wrap justify-center items-center bg-gray-600 rounded-md p-1 mt-20 w-4/5">
