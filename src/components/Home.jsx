  ...
  <div className='bg-gray-800 w-full grow'>
    <div className='container flex flex-col mx-auto px-4 py-16 justify-between items-center md:flex-row md:pl-16'>
      <div className='md:w-1/2'>
        <h1 className='mb-5 text-white'>Welcome to My Site</h1>
        <button className='rounded-xl border-white bg-gray-800 p-3 mr-2 mb-5 inline-block text-white'><Link to='/projects'>Full Stack</Link></button>
        <button className='rounded-xl border-white bg-gray-800 p-3 mr-2 mb-5 inline-block text-white' disabled title='Coming Soon'>iOS Apps</button>
        <span className="flex flex-wrap justify-center gap-1 items-center bg-gray-600 rounded-md p-1 mt-20 md:w-4/5 grow">
